...
var ERROR_MSG = {
    ...
    'ERR_PARK_NO_UPDATE' : '{"state":"error", "code":52, "error":"车位租用期间不能更新"}',
    'ERR_DATA_NO_EXIST' : '{"state":"error", "code":52, "error":"数据不存在"}', 
};
...
*/
AV.Cloud.define('kaka_upload_image', function(request, response) {
