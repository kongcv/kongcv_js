...
window.onload=function(){
	...
	AV.Cloud.run('kongcv_get_hire_method', {"park_type_id":"5620a6dc60b27457e84bb21d"}, {
	...
	kuang1.onclick=function(){
		...
		fabu.onclick=function(){
			...
			alert(arrr3)
			alert(arrr4)*/
			console.log({"user_id":user_id,"worker_id":phone,"address":address,"park_detail":detail,"park_description":description,"location_info":{"__type":"GeoPoint","latitude":latitude,"longitude":longitude}, "hire_start":start, "hire_end":end,"no_hire":no_hire,"tail_num":num,"city":city, "normal":Bok, "park_area":area,"park_height":height, "gate_card":card,"hire_method_id":arrr,"hire_field":arrr2,"hire_price":arrr3,"hire_time":arrr4,"park_struct":park_struct,"mode":"community"});
